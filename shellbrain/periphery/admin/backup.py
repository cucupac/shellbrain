...
from shellbrain.periphery.admin.instance_guard import PROTECTED_DB_NAMES, fetch_instance_metadata, fingerprint_summary
...
def restore_backup(
    *,
    ...
    from shellbrain.periphery.admin.instance_guard import ensure_instance_metadata

    target_admin_dsn = _replace_database(admin_dsn, target_db)
    ensure_instance_metadata(
        target_admin_dsn,
        instance_mode="scratch",
        created_by="shellbrain.admin.restore",
