...
from shellbrain.periphery.episodes.source_discovery import SUPPORTED_HOSTS, default_search_roots
from shellbrain.periphery.identity.claude_runtime import (
    detect_claude_runtime_without_hook,
    resolve_trusted_claude_caller_identity,
    resolve_trusted_claude_transcript_path,
)
from shellbrain.periphery.identity.codex_runtime import (
    resolve_codex_caller_identity,
    resolve_codex_transcript_for_caller,
)
from shellbrain.periphery.identity.compatibility import (
    host_hook_missing_error,
    host_identity_drifted_error,
    host_identity_unsupported_error,
)
from shellbrain.periphery.telemetry.session_selection import discover_events_candidate
