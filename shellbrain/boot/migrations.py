...
from shellbrain.boot.admin_db import get_admin_db_dsn, get_backup_dir, get_backup_mirror_dir, get_instance_mode_default
...
from shellbrain.periphery.admin.instance_guard import ensure_instance_metadata, fetch_instance_metadata
...
def upgrade_database(revision: str = "head") -> None:
    ...
    if _database_has_shellbrain_objects(admin_dsn):
        ...
        verify_backup(backup_root=get_backup_dir(), backup_id=manifest.backup_id)
    ...
    if fetch_instance_metadata(admin_dsn) is None:
        ensure_instance_metadata(
            ...
            created_by="shellbrain.admin.migrate",
