...
from app.periphery.local_state.backup_manifest_store import list_backup_manifests, write_backup_manifest
from app.periphery.postgres_admin.instance_guard import PROTECTED_DB_NAMES, fetch_instance_metadata, fingerprint_summary
...
def restore_backup(
    *,
    ...
    from app.periphery.postgres_admin.instance_guard import ensure_instance_metadata
