...
from app.periphery.host_transcripts.source_discovery import SUPPORTED_HOSTS, default_search_roots
from app.periphery.host_identity.claude_runtime import (
    detect_claude_runtime_without_hook,
    resolve_trusted_claude_caller_identity,
    resolve_trusted_claude_transcript_path,
)
from app.periphery.host_identity.codex_runtime import (
    resolve_codex_caller_identity,
    resolve_codex_transcript_for_caller,
)
from app.periphery.host_identity.compatibility import (
    host_hook_missing_error,
    host_identity_drifted_error,
    host_identity_unsupported_error,
)
from app.periphery.host_transcripts.session_selection import discover_events_candidate
