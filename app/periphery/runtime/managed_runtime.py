...
from app.periphery.local_state.paths import get_machine_backups_dir, get_machine_models_dir, get_machine_postgres_data_dir, get_shellbrain_home
...
from app.periphery.postgres_admin.instance_guard import dsn_fingerprint, ensure_instance_metadata
...
def build_fresh_machine_config(*, embeddings: dict[str, object]) -> MachineConfig:
