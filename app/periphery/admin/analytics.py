...
from app.periphery.admin.analytics_queries import (
...
def build_analytics_report(*, engine: Engine, days: int) -> dict[str, Any]:
    """Return one cross-repo telemetry report for reviewer agents."""
