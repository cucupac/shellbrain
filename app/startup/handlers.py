...
from app.handlers.internal_agent.concepts.add import run_concept_add_operation
from app.handlers.internal_agent.concepts.update import (
    run_concept_update_operation,
)
from app.handlers.command_context import OperationDependencies
from app.handlers.telemetry_sink import TelemetrySink
