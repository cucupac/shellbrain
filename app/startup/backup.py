...
def verify_backup(**kwargs) -> BackupManifest:
    ...
    result = verify_backup_use_case(verify_logical_backup=logical_backup.verify_backup, **kwargs)
    return logical_backup.resolve_backup(backup_root=kwargs["backup_root"], backup_id=result.backup_id)
