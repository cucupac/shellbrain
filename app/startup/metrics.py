...
from app.core.use_cases.metrics.generate_dashboard import MetricsDashboardResult, generate_metrics_dashboard
...
def run_metrics_dashboard(*, warn_or_fail_on_unsafe_app_role: Callable[[], None]) -> MetricsDashboardResult:
