...
from app.core.use_cases.agent_operations.concepts.apply import run_concept_changes_operation
from app.core.use_cases.agent_operations.dependencies import OperationDependencies
from app.core.use_cases.agent_operations.events.read import run_read_events_operation
from app.core.use_cases.agent_operations.memories.add import run_create_memory_operation
from app.core.use_cases.agent_operations.memories.update import run_update_memory_operation
from app.core.use_cases.agent_operations.retrieval.read import run_read_memory_operation
from app.core.use_cases.agent_operations.retrieval.recall import run_recall_memory_operation
...
def handle_concept(
    request: ConceptCommandRequest | None,
    *,
    uow_factory,
    inferred_repo_id: str,
    validation_errors: list[ErrorDetail] | None = None,
