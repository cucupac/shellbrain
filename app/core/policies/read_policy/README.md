...
- This repository stores short atomic memories, so a relevant memory can easily miss one query term and still be useful.
...
- `keyword_retrieval_repo.py`: visibility-gated corpus loading plus orchestration of the lexical helpers.
