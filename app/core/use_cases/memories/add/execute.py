...
from app.core.use_cases.memories.add.result import CreateMemoryResult, CreatePlanIds
...
def execute_create_memory(
    ...
    *,
    ...
    return CreateMemoryResult(memory_id=plan_ids.memory_id, planned_effects=plan)
