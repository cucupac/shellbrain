...
from app.core.use_cases.agent_operations.events_selection import (
...
from app.core.use_cases.agent_operations.serialization import serialize_episode_event
    ...
    *,
    ...
    try:
        if validation_errors:
            ...
            result = error_response([ErrorDetail(code=ErrorCode.SCHEMA_ERROR, message="events request is required")])
        else:
