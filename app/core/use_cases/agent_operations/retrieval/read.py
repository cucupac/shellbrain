...
from app.core.use_cases.agent_operations.retrieval_execution import execute_read_memory_with_dependencies
    ...
    *,
    ...
    try:
        if validation_errors:
            ...
            result = error_response([ErrorDetail(code=ErrorCode.SCHEMA_ERROR, message="read request is required")])
        else:
            with uow_factory() as uow:
                result = execute_read_memory_with_dependencies(request=request, uow=uow, dependencies=dependencies).model_dump(mode="python")
