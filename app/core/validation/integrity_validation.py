"""This module defines database-integrity compatibility checks for validated requests."""
...
def _is_visible(memory: Memory, repo_id: str) -> bool:
    """This function determines whether a memory is visible inside a repo operation context."""
...
def _require_memory(uow: IUnitOfWork, *, memory_id: str, field: str) -> tuple[Memory | None, list[ErrorDetail]]:
    """This function fetches a memory row and returns a not-found contract error when missing."""
...
def validate_create_integrity(request: MemoryCreateRequest, uow: IUnitOfWork) -> list[ErrorDetail]:
    """This function validates database integrity constraints for create operations."""
...
def validate_update_integrity(request: MemoryUpdateRequest, uow: IUnitOfWork) -> list[ErrorDetail]:
    """This function validates database integrity constraints for update operations."""
