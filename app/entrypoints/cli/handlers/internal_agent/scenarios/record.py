"""Agent operation workflow for recording bounded scenarios."""
...
def run_scenario_record_operation(
    request: ScenarioRecordRequest | None,
    *,
    ...
    """Dispatch a typed scenario-record payload."""
            ...
            result = error_response(
                [
                    ErrorDetail(
                        ...
                        message="scenario record request is required",
                    )
                ]
            )
        else:
