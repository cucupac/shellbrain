...
class CodexCliInnerAgentRunner:
    ...
    def __init__(
        ...
        *,
        ...
        allow_unbounded_cli: bool,
    ) -> None:
        """Store provider configuration."""

        self._command = command
        self._working_directory = working_directory
        self._allow_unbounded_cli = allow_unbounded_cli
    ...
    def run(self, request: InnerAgentRunRequest) -> InnerAgentRunResult:
        ...
        if not self._allow_unbounded_cli:
            return _result(
                request,
                status="provider_unavailable",
                fallback_used=True,
                error_code="bounded_mode_unavailable",
                error_message=(
                    "Codex CLI provider is configured, but unbounded CLI execution "
                    "is not allowed"
                ),
            )
...
def _result(
    ...
    *,
    ...
    requested_expansions: list[dict] | None = None,
) -> InnerAgentRunResult:
    ...
    return InnerAgentRunResult(
        ...
        requested_expansions=requested_expansions or [],
    )
