...
from app.infrastructure.db.runtime.repos.relational.associations_repo import AssociationsRepo
from app.infrastructure.db.runtime.repos.relational.concepts_repo import ConceptsRepo
from app.infrastructure.db.runtime.repos.relational.episodes_repo import EpisodesRepo
from app.infrastructure.db.runtime.repos.relational.evidence_repo import EvidenceRepo
from app.infrastructure.db.runtime.repos.relational.experiences_repo import ExperiencesRepo
from app.infrastructure.db.runtime.repos.relational.knowledge_builder_repo import (
...
from app.infrastructure.db.runtime.repos.relational.repository_index_repo import (
    RepositoryIndexRepo,
)
from app.infrastructure.db.runtime.repos.relational.snapshots_repo import SnapshotsRepo
...
from app.infrastructure.db.runtime.repos.relational.wiki_summaries_repo import (
    WikiSummariesRepo,
)
...
class PostgresUnitOfWork(IUnitOfWork):
    ...
    def __enter__(self):
        ...
        self.repository_index = RepositoryIndexRepo(self._session)
        self.snapshots = SnapshotsRepo(self._session)
        self.wiki_summaries = WikiSummariesRepo(self._session)
        return self
