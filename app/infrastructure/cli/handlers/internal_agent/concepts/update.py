"""Agent operation workflow for updating concept graph records."""
...
from app.core.contracts.concepts import ConceptUpdateRequest
...
from app.infrastructure.cli.handlers.command_context import (
    ensure_telemetry_context,
)
from app.core.use_cases.concepts.update import update_concepts


def run_concept_update_operation(
    ...
    *,
    ...
    """Dispatch a typed concept-update payload."""
            ...
            result = error_response(
                [
                    ErrorDetail(
                        ...
                        message="concept update request is required",
                    )
                ]
            )
        else:
