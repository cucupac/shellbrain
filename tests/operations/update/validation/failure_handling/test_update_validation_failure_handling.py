...
def test_rejected_update_requests_write_nothing(
    ...
    semantic_failure_result = handle_update(semantic_failure_payload, uow_factory=uow_factory)
    ...
    integrity_failure_result = handle_update(integrity_failure_payload, uow_factory=uow_factory)
